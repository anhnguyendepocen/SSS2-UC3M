...
**Is $0$ inside the CI for $\beta_j$ of level $\alpha$?**
...
```{block, type = 'rmdexercise'}
- Check that: 
    * The intercept of `y7 ~ x7` is not significant at any reasonable level $\alpha$.
    * The slope is significant for any $\alpha>10^{-7}$.
  
- Assume the linear model assumptions were verified for `y6 ~ x6`. 
