...
TBA
<!--
Identify the problems with the following `R` codes, compared with what they were meant to do. **All of them are wrong!** They may generate an error or do something different to what is asked. Work out the right answer.

1. "Compute the mean of $-1.23, \sqrt{2}, 2.34, 5, 0.15$"
    - `mean(-1.23, sqrt(2), 2.34, 5, 0.15)`
    - `mean(c(-1.23, 2^1/2, 2.34, 5, 0.15))`
    - `mean(c(-1.23, sqrt(2), 2.34, 5, 0.15)`
2. "Compute the variance of `x`"
    - `sum(x^2)`
    - `mean(x^2)`
    - `sd(x)`
3. "Compute the linear model of `x`"
4. "Compute "
5. "Compute "
6. "Compute "
7. "Compute "
