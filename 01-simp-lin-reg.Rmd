...
- `MeanMath` regressed on `MeanReading`. Compare it with `MeanMath` on `MeanScience`. Which pair of variables has the highest linear relation? Is that something expected?
