...
- Use `R Commander`'s report mode (Appendix \@ref(appendix-reporting)) to simplify the generation of graphs and summaries directly from the statistical analysis. Use that code to make the analysis reproducible.
