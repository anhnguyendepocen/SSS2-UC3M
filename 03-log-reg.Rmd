...
knitr::include_app('http://ec2-35-177-34-200.eu-west-2.compute.amazonaws.com:3838/log-maximum-likelihood/', height = '900px')
```
...
knitr::include_app('http://ec2-35-177-34-200.eu-west-2.compute.amazonaws.com:3838/log-random/', height = '1000px')
```
...
knitr::include_app('http://ec2-35-177-34-200.eu-west-2.compute.amazonaws.com:3838/log-ci-prediction/', height = '1000px')
```
...
knitr::include_app('http://ec2-35-177-34-200.eu-west-2.compute.amazonaws.com:3838/log-reg-non-lin/', height = '1000px')
```
-->
