...
```{r, kmeans, echo = FALSE, results = 'hide', out.width = '90%', fig.show = 'hold', fig.asp = 1, fig.align = 'center', fig.cap = 'The $k$-means partitions for a two-dimensional dataset with $k=1,2,3,4$. Centers of each cluster are displayed with an asterisk.'}
...
```{r, trees, echo = FALSE, results = 'hide', out.width = '90%', fig.show = 'hold', fig.asp = 1, fig.align = 'center', fig.cap = 'The hierarchical clustering for a two-dimensional dataset with complete, single and average linkages.'}
# Data with 3 clusters
set.seed(23456789)
n <- 10
x <- rbind(matrix(rnorm(n, sd = 0.3), ncol = 2),
...
```{r, collapse=TRUE, out.width = '70%', fig.align = 'center', fig.asp = 1, warning=FALSE}
