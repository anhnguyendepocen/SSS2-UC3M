...
- If $k=2$, we need at least $n=3$ points to fit uniquely a plane. But this this plane gives no information on the variation of the data around it and hence $\hat\sigma^2$ can not be estimated. Therefore we need $n\geq k + 2=4$.
