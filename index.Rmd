...
- Group project. The students must team up in groups of 4 ($\pm1$) in order to produce a report. This report must apply the methodology presented to a dataset of their choice. As a rule of thumb, all students in a group will be graded evenly and according to the ratio $\frac{\text{quality project}}{\text{group size}}$. Bear in mind it when choosing coworkers. Specific details will be disclosed near the end of the course.
