...
```{r ScreenshotRcmdr, echo = FALSE, out.width = '90%', fig.cap = 'Main window of `R Commander`, with the plug-ins `RcmdrPlugin.FactoMineR`, `RcmdrPlugin.KMggplot2` and `RcmdrPlugin.Demos` loaded.'}
